...
{{--                                <a href="index.html"> <i class="feather icon-home"></i> </a>--}}
    ...
    <create-rate-card :rate_card_title_id="'{!! \Illuminate\Support\Facades\Session::get('rate_card_title_id') !!}'"  :media="'{!! \Illuminate\Support\Facades\Session::get('media') !!}'"></create-rate-card>
    </div>
