                  ...
                  <table class="table table-striped table-bordered nowrap">
                    <thead>
                      <tr class="table-primary animated fadeIn" v-show="weekdays">
                        ...
                        <th
                          v-show="days_of_week.sec1 > 0"
                        >{{days_of_week.sec1 + days_of_week.time1}}</th>
                        <th
                          v-show="days_of_week.sec2 > 0"
                        >{{days_of_week.sec2 + days_of_week.time2}}</th>
                        <th
                          v-show="days_of_week.sec3 > 0"
                        >{{days_of_week.sec3 + days_of_week.time3}}</th>
                        <th
                          v-show="days_of_week.sec4 > 0"
                        >{{days_of_week.sec4 + days_of_week.time4}}</th>
                        <th
                          v-show="days_of_week.sec5 > 0"
                        >{{days_of_week.sec5 + days_of_week.time5}}</th>
                      </tr>
                    ...
                    <tbody>
                      ...
                      <tr
                        ...
                        v-for="(card,index) in view_rate_card"
                        v-show="weekdays"
                      >
