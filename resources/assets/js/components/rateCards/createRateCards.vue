        ...
        <div class="page-body">
            ...
            <div class="card" v-show="media != 'Print'">
                <div class="card-header">
                    ...
                    <span>Click on the add row button to add new row.Insert your data from monday-friday</span>  <span v-show="show_rate"><strong>{{create}}</strong></span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered" id="example-1">
                            ...
                            <tr>
                                ...
                                <th class="create-ad-tb-th"><input type="number" class="spin"  v-model="days_of_the_week_and_durations.sec1" style="width: 50px !important;border: none">
                                ...
                                <th class="create-ad-tb-th"><input type="number"  class="spin" v-model="days_of_the_week_and_durations.sec2" style="width: 50px !important;border: none">
                                ...
                                <th class="create-ad-tb-th"><input type="number" class="spin" v-model="days_of_the_week_and_durations.sec3" style="width: 50px !important;border: none" >
                                ...
                                <th class="create-ad-tb-th"><input type="number" class="spin"  v-model="days_of_the_week_and_durations.sec4" style="width: 50px !important;border: none" >
                                ...
                                <th class="create-ad-tb-th"><input type="number" class="spin" v-model="days_of_the_week_and_durations.sec5" style="width: 50px !important;border: none" >
                            ...
                            <tr :class="r_animate"   style="border: none;background: transparent" v-for="(dtl, index) in data_list" :key="index">
                              <td>{{index + 1}}</td>
                                <td><select class=""  required type="text"    v-model="dtl.mon_duration">
                                    <option value="" disabled selected>HR</option>
                                    <option v-for="hr in hour">{{hr}}</option>
                                </select>
                                    :
                                    <select class="" required type="text"    v-model="dtl.mon_b_duration">
                                        <option value="" disabled selected>MM</option>
                                        <option v-for="mn in mins">{{mn}}</option>
                                    </select>
                                    To <select class="" type="text" required    v-model="dtl.mon_c_duration">
                                        <option value="" disabled selected>HR</option>
                                        <option v-for="hr in hour">{{hr}}</option>
                                    </select>
                                    :
                                    <select class="" type="text" required    v-model="dtl.mon_d_duration">
                                        <option value="" disabled selected>MM</option>
                                        <option v-for="mn in mins">{{mn}}</option>
                                    </select>
                                ...
                                <td><select type="text"   v-model="dtl.tue_duration">
                                    <option value="" disabled selected>HR</option>
                                    <option v-for="hr in hour">{{hr}}</option>
                                </select>
                                    :
                                    <select class="" type="text" required    v-model="dtl.tue_b_duration">
                                        <option value="" disabled selected>MM</option>
                                        <option v-for="mn in mins">{{mn}}</option>
                                    </select>
                                ...
                                <td><select type="text"   v-model="dtl.wed_duration">
                                    <option value="" disabled selected>HR</option>
                                    <option v-for="hr in hour">{{hr}}</option>
                                </select>
                                    :
                                    <select class="" type="text" required    v-model="dtl.wed_b_duration">
                                        <option value="" disabled selected>MM</option>
                                        <option v-for="mn in mins">{{mn}}</option>
                                    </select>
                                ...
                                <td>
                                    ...
                                    :
                                    <select class="" type="text" required    v-model="dtl.thu_b_duration">
                                        <option v-for="mn in mins">{{mn}}</option>
                                    </select>
                                ...
                                <td><select type="text"   v-model="dtl.fri_duration">
                                    <option value="" disabled selected>HR</option>
                                    <option v-for="hr in hour">{{hr}}</option>
                                </select>
                                    :
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered" id="example-2">
                            ...
                            <tr v-for="(wdtl, index) in wdata_list" style="border: none;background: transparent">
                                ...
                                <td><select class="" type="text"   v-model="wdtl.sat_duration">
                                    <option value="" disabled selected>MM</option>
                                    <option v-for="hr in hour">{{hr}}</option>
                                </select>
                                    :
            ...
            <button type="button" class="btn btn-danger waves-effect waves-light add pull-right" @click="insertResults()">Submit </button>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                days_of_the_week_and_durations: { mon : "MON", tue : 'TUE', wed : 'WED', thu : 'THU', fri : 'FRI',
                ...
                show_rate : false,
                hour : ['01 AM','02 AM','03 AM','04 AM','05 AM','06 AM','07 AM','08 AM','09 AM',
                    '10 AM','11 AM','12 AM','13 PM','14 PM','15 PM','16 PM','17 PM','18 PM',
                    '19 PM','20 PM','21 PM','22 PM','23 PM','12AM'],
