                ...
                <div class="card-block table-border-style">
                    <div class="table-responsive">
                        <table  class="table  table-striped table-bordered nowrap">
                            ...
                            <!--</div>-->
                            <tr  v-for="(sub,index) in activeSubs">
...
<script>
    ...
    export default {
        ...
        mounted(){
           // this.fetchActiveSub();
            store.dispatch('activeSubs',this.pagi.current_page)

        },
        methods:{
            fetchActiveSub(){
                let self = this;
                axios.get('fetch-active-subs/api').then(function (res) {
