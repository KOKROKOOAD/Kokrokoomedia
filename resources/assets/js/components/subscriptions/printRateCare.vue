...
<!--                                    <td class="text-center"><input class="form-control" type="date" data-date-format="DD-MMMM-YYYY" v-model="dtl.end" style="border-color:transparent;background:transparent"> </td>-->
                                    <td class="text-center"><input class="form-control" type="text" v-model="dtl.sizeAndPosition" style="border-color:transparent;background:transparent"> </td>
                                    <td class="text-center"><input class="form-control" type="number" v-model="dtl.spots" style="border-color:transparent;background:transparent"> </td>
                                    <td class="text-center"><input type="text" v-model="dtl.rate" style="border-color:transparent;background:transparent">  </td>
                                    <td>
                ...
                <button type="button" class="btn btn-secondary btn-sm waves-effect waves-light add" @click="addRow">Add Row</button>
