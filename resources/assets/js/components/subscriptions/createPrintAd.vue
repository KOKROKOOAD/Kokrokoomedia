    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="molLabel1">
            <span class="text-danger">{{media[0]}}</span>
            - {{title}} Printing
          </h4>
                ...
                <div class="card-body">
                  ...
                  <form v-on:submit.prevent>
                    <div class="table-responsive">
                      <button
                        class="btn btn-outline-info pull-right text-danger"
                        style="border:none !important;font-weight: bolder;text-decoration: underline"
                      >View advert positions</button>
                      <table class="table table-bordered" id="weekdays-tb">
                        <thead>
                          <tr
                            class="tb-rw weekdays"
                            style="background: #36475F;color:#ffffff;font-family: "Roboto", sans-serif;font-weight: 500;font-size: 13px;"
                          >
                            <th>ADVERT SIZE</th>
                        ...
                        <tbody>
                          <tr
                            ...
                            v-for="(dtl,index) in segments_data"
                            :key="index"
                          >
                            <td>{{dtl.adSize}}</td>
                            <td>
                              <input
                                ...
                                value="{'segment':dtl.adSize,'rate':dtl.rate}"
                                v-model="createAd.printAd"
                              />
                              {{dtl.rate}}
                            </td>
                            <!--<td>{{dtl.vat}}</td>-->
                            <td>
                              <input
                                ...
                                v-model="createAd.dates[index]"
                              />
                              <button
                                class="btn btn-primary btn-xs"
                                @click="storeDates(index)"
                                style="border:none"
                              >
