          ...
          <div class="table-responsive">
            <table id="" class="table table-striped table-bordered nowrap">
              ...
              <tbody>
                ...
                <!--</div>-->
                <tr v-for="(sub,index) in acceptedSubs" :key="index">
...
export default {
  ...
  mounted() {
    //this.fetchAcceptedSub();
    store.dispatch("acceptedSubs", this.pagi.current_page);
  },
  methods: {
    fetchAcceptedSub() {
      let self = this;
      axios.get("fetch-accepted-subs/api").then(function(res) {
