                ...
                <div class="card-block table-border-style">
                    <div class="table-responsive">
                        <table   class="table  table-striped table-bordered nowrap">
                            ...
                            <!--</div>-->
                            <tr  v-for="(sub,index) in expiredSubs">
...
<script>
    ...
    export default {
        ...
        mounted(){
           // this.fetchExpiredSub();
            store.dispatch('expiredSubs',this.pagi.current_page)

        },
        methods:{
            fetchExpiredSub(){
                let self = this;
                axios.get('fetch-expired-subs/api').then(function (res) {
        ...
        computed:{
            expiredSubs(){
                return store.state.expiredSubs;
            },
            pagi(){
