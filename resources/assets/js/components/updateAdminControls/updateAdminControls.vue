<template>
  <span>
    <button
      ...
      @click="deactivateAdmin(adminId,adminStatus)"
    >
    ...
    activateAdmin(adminId) {
      ...
      sweetAlert(
        ...
        function(isConfirm) {
          if (isConfirm) {
            axios
              .post("unblock-admin/api", formData)
              .then(function(res) {
                if (res.data === "success") {
                  window.location = "manage-admins";
                }
    ...
    deleteAdmin(adminId) {
      ...
      sweetAlert(
        ...
        function(isConfirm) {
          if (isConfirm) {
            axios
              .post("delete-admin/api", formData)
              .then(function(res) {
                if (res.data === "success") {
                  window.location = "manage-admins";
                }
