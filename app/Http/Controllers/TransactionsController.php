        ...
        if(request()->ajax()) {
            ...
            return datatables()->of($trans)
                ->addColumn('action', function($row){
                    ...
                    $btn =$btn.  '<a href="/admin/subscriptions/'.$row->transaction_id.'" data-toggle="tooltip"     data-id="'.$row->transaction_id.'" data-original-title="view" class="edit btn  view-sub"><i class="fa fa-eye"></i></a>';
